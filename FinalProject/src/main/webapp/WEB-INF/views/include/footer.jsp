	...
	<div class="footer__inner">
		<div class="footer__info">
						...
						<div class="layer__basic__cont">
							<div class="layer__footer-law">
								...
								<div class="layer__footer-law__noti">
									<p class="text">
										이젠컴퓨터아카데미 홈페이지 내의 모든 콘텐츠는 『콘텐츠산업 진흥법』에 따라 <br> 제작일 또는 그
										갱신일로부터 5년간 보호 됩니다.
									</p>
								</div>
							</div>
			...
			<div class="footer__point">
				이젠컴퓨터아카데미는 상품판매와 직접적인 관련이 없으며, 모든 상거래의 책임은 구매자와 판매자에게 있습니다.<br>
				이에 대해 이젠컴퓨터아카데미는 일체의 책임을 지지 않습니다.<br> 본사에 등록된 모든 광고와 저작권 및
						...
						<div class="layer__basic__wrap">
							...
							<div class="layer__basic__cont">
								<div class="layer__footer-denyemail">
									<p class="contents">
										영리목적 이젠컴퓨터아카데미에서는 본 웹사이트에 게시된 이메일 주소가<br> 전자우편 수집 프로그램이나
